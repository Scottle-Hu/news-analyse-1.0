...
!function ($) {
    ...
    var is_oozie_url = current_url.indexOf("/oozie/editor/workflow/list/") > 0 || current_url.indexOf("/oozie/editor/coordinator/list/") > 0 ? true : false
    ...
    BootstrapTable.DEFAULTS = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('共%s条记录,每页显示<span class="totle">10</span>条记录', totalRows);
        },
    ...
    BootstrapTable.prototype.initEditable = function () {
        $.each(this.getData(), function (index, item) {
            edittagname(index, item.tagname, item.id)
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.search) {
            html = [];
            html.push(
                '<div class="pull-' + this.options.searchAlign + ' search search-position">',
                sprintf('<input id="solor_data" class="form-control" type="text" placeholder="%s">',
            ...
            $search.off('keyup').on('keyup', function (event) {
                if (window.location.pathname == "/about/" || window.location.pathname == "/index") {
                    document.getElementById("t2By").value = document.getElementById("solor_data").value;
                    var fileTableSearch = ko.dataFor(document.getElementById("t2By"));
                    fileTableSearch.searchQuery(document.getElementById("solor_data").value);
                }
                // $("#t2By").keyup()
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            ...
            '<ul class="pagination">',
            '<li class="page-first"><a class="fa fa-fast-backward"href="javascript:void(0)"></a></li>',
            '<li class="page-pre"><a class="fa fa-backward" href="javascript:void(0)"></a></li>');
        ...
        html.push(
            '<li class="page-next"><a class="fa fa-forward" href="javascript:void(0)"></a></li>',
            '<li class="page-last"><a  class="fa fa-fast-forward" href="javascript:void(0)"></a></li>',
            '</ul>',
            '</div>');
    ...
    BootstrapTable.prototype.insertRowOdeon = function (params) {
